...
## 2. Выполнить редистрибуцию маршрутов из BGP в протокол IGP. (Рабочее решение, но не правильное).
...
Добавить в таблицу маршрутизации роутера R18 маршрут по умолчанию замкнутый на интерфейс Null0. Далее он распространиться по протоколо EIGRP.
