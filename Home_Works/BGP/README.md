...
1. Добавить в ананс BGP конечные сети пользователей
 ...
 Для Москвы на роутерах R14 и R15 выполнить:
  ...
  Так же таблица маршрутизации R21 добавилось 4 маршрутами BGP
  
  ![](bgp_r21.png)
  
  В таблицу маршрутизации роутеров R14 и R15 так же добавились маршруты BGP до сетей 192.168.40.0 /24 и 192.168.50.0 24
