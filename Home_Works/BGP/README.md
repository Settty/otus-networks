...
1. Добавить в ананс BGP конечные сети пользователей
 ...
 Для Москвы на роутерах R14 и R15 выполнить:
  ...
  Как видно из скриншота, установлено BGP соседство, и анонсировна по 2 сети от роутеров. На это указывает последний столбец из скриншота State/PfxRcd с числом 2.
