...
При выполнении лабораторной работы некоторые описательные шаги пропущенны, но выполнены.

Bridge ID коммутаторов:
* S1 - 32769.0060.703C.B366
* S2 - 32769.000C.CF97.7E37 (ROOT коммутатор)
* S3 - 32769.00E0.F959.237A
...
После прохождения всех этапов выбора root коммутатора, root коммутатором становится S2. Далее это можно увидеть на скриншотах ниже.
